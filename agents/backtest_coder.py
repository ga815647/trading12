...
def generate_backtest_code(hypothesis: dict[str, Any]) -> str:
    """
    使用 LLM 生成單一假設的回測程式碼
    """
    try:
...
def generate_all_backtests(hypotheses_file: str | Path, output_file: str | Path, target_id: str | None = None) -> None:
    """
    為所有或指定假設生成回測程式碼
    """
    ...
    for hypothesis in hypotheses:
        hypothesis_id = hypothesis.get("hypothesis_id", "")
        print(f"Generating code for {hypothesis_id}...")
        code = generate_backtest_code(hypothesis)
...
if __name__ == "__main__":
    ...
    generate_all_backtests(args.input, args.output, target_id=args.hypothesis_id)
