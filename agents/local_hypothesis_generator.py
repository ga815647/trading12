...
def generate_local_factory():
    ...
    theme_a_grid = {
        "id": ["A01", "A02", "A03", "A05"],
        "threshold_a": [100, 300, 500, 1000],
        "consecutive_n": [3, 5, 10],
        "horizon_days": [10, 20, 60]
    }
    ...
    theme_b_grid = {
        ...
        "bar_body_pct": [0.03, 0.05, 0.10],
        "consecutive_n": [3, 5, 20],
